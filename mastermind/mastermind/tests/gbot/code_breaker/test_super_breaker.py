...
class TestSuperMastermindBreaker:
    """Die Event-Tests dauern etwas länger"""
    ...
    def test_reduce_codes_event(self, breaker_bot):
        ...
        mock_pub.sendMessage.assert_called_once_with("add_guess", guess=[Colors.BLUE, Colors.BLUE, Colors.GREEN,
                                                                         Colors.GREEN, Colors.WHITE])

        rating = [Colors.BLACK, Colors.WHITE, Colors.WHITE]
        breaker_bot.reduce_codes(rating)
        breaker_bot.generate_next_guess()

        expected_calls = [
            call("add_guess", guess=[Colors.BLUE, Colors.BLUE, Colors.GREEN, Colors.GREEN, Colors.WHITE]),
            call("add_guess", guess=[Colors.RED, Colors.YELLOW, Colors.BLUE, Colors.GREEN, Colors.BLUE])
        ]
